...
const Meter = () => {
 ...
 return (
   <div className="bg-white min-h-screen">
     {/* Container หลัก */}
     <div className="max-w-7xl mx-auto bg-white rounded-3xl p-6 shadow-lg border border-gray-200 min-h-[85vh] relative pb-18">
       {/* 1. Header แสดงชื่อเดือน ปี */}
       <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">
         จดมิเตอร์ เดือน{currentMonthLabel}
       </h1>
       ...
       <div className="flex flex-col items-center gap-6 mb-8">
         <div className="flex flex-col md:flex-row w-full max-w-4xl gap-3 items-stretch">
           ...
           <div className="flex-1 flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3 min-w-30 h-full relative focus-within:border-[#f3a638]">
         ...
         {/* Row 2: Meter Type Tabs (ตัดจดรวมออก) */}
           ...
           {[
             ...
             <button
               ...
               className={`flex-1 flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl font-bold transition-all ${
                 meterType === type.id
                   ? type.id === "electricity"
                     ? "bg-[#f17721] text-white shadow-md"
       ...
       {/* 2. ปรับ Floor Selection  */}
       <div className="flex justify-center mb-3">
         <div className="flex flex-col sm:flex-row items-center gap-1 bg-gray-50 p-2 rounded-2xl border border-gray-200">
       ...
       <div className="max-w-5xl mx-auto">
         {/* Header บอกสถานะ (Optional: เก็บไว้ช่วยเตือนความจำ) */}
         <div className="mb-2 flex items-center justify-end gap-2 text-xs text-gray-400 font-medium px-2">
           ...
           <span>➜</span>
           <span className="text-[#f3a638] font-bold">
             {currentMonthLabel}
           </span>
         </div>
     ...
     {/* --- Sticky Footer (เหลือแค่ปุ่มบันทึก ชิดขวา) --- */}
     <div className="fixed bottom-0 left-0 right-0 bg-[#fff1e1] py-2 z-30 overflow-visible">
